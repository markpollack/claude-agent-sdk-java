package io.github.markpollack.claude.agent.examples.email.controller;

import java.util.List;

import org.slf4j.Logger;
import org.slf4j.LoggerFactory;
import io.github.markpollack.claude.agent.examples.email.model.Email;
import io.github.markpollack.claude.agent.examples.email.service.ClaudeService;
import io.github.markpollack.claude.agent.examples.email.service.EmailSeeder;
import io.github.markpollack.claude.agent.examples.email.service.ImapService;
