...
package io.github.markpollack.claude.agent.sdk.test;
...
public abstract class ClaudeCliTestBase {
	...
	static void discoverClaudeCli() {
		try {
			claudeCliPath = io.github.markpollack.claude.agent.sdk.config.ClaudeCliDiscovery.discoverClaudePath();
			logger.info("Claude CLI tests will use executable at: {}", claudeCliPath);
		}
		catch (io.github.markpollack.claude.agent.sdk.config.ClaudeCliDiscovery.ClaudeCliNotFoundException e) {
